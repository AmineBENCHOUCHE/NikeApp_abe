...
const ServiceCard = ({ imgURL, label, subtext }) => {
	return (
		...
		>
			<div className="w-11 h-11 flex  bg-red-500 justify-center bg-center bg-cover rounded-full items-center">
				<img src={imgURL} alt="icon" width={24} height={24} />
			</div>
			<h3 className="font-bold font-palanquin text-3xl mt-5 leading-normal">
				{label}
			</h3>
			<p className="info-text mt-4 break-words leading-normal font-montserrat">
				{subtext}
			</p>
		</motion.div>
	);
