...
const PopularProductCard = ({ imgURL, name, price }) => {
	return (
		<div className="flex flex-1 flex-col w-full max-sm:w-full shadow-md shadow-red-300  p-4 rounded-lg  hover:animate-bounce-short  ">
			...
			<div className="mt-8 flex flex-col justify-start gap-2.5">
				...
				<p className=" relative  mt-2 font-montserrat font-semibold text-2xl leading-normal text-red-500 ">
					{price}
				</p>
			</div>
		</div>
