  ...
  return (
    <div className='flex flex-1 flex-col w-full max-sm:w-full shadow-md shadow-red-300  p-4 rounded-lg'>
        ...
        <div className='mt-8 flex flex-col justify-start gap-2.5'>
            ...
            <h3 className='text-xl mt-2 leading-normal font-semibold font-palanquin '>{name}</h3>
            <p className='mt-2 font-montserrat font-semibold text-2xl leading-normal text-red-500'>{price}</p>
